...
<body>
	...
	<s:form action="registerUser">
		...
		<table class="table1">
			...
			<tr>
				<td colspan="2"><s:multibox property="areaOfInterest" value="Web Programming"/><bean:message key="label.update.webprograming" />
				</td>

			</tr>
			<tr>
				<td colspan="2"><s:multibox property="areaOfInterest" value="Database Programming" /><bean:message
						key="label.update.databaseprograming" /></td>
			</tr>
			<tr>
				<td colspan="2"><s:multibox property="areaOfInterest" value="Swing Programming"/><bean:message
						key="label.update.swingprograming" /></td>
			</tr>
			<tr>
				<td colspan="2"><s:multibox property="areaOfInterest" value="Mobile Programming"/><bean:message key="label.update.mobileprograming" />
					</td>
			</tr>
