...
<script>
	function clearErrorMessage() {
		window.location.href = "/WelcomeProject/jsp/Login.jsp";
	}
</script>
<style type="text/css">
...
<body bgcolor="wheat">
	<s:form action="login" method="post" namespace="/">
		<table align="center"
			...
			<tr>
				<td><s:textfield label="User Name " name="objuser.userid"
						placeholder="Enter Username" /></td>
			</tr>
			<tr>
				<td><s:password label="Password " name="objuser.password"
						placeholder="Enter Password" /></td>
			</tr>
			<tr>
				<td colspan="2" align="center"><s:submit value="Login"
						theme="simple"></s:submit> <s:reset value="Clear" theme="simple"
						onclick="clearErrorMessage();"></s:reset></td>
		</table>
