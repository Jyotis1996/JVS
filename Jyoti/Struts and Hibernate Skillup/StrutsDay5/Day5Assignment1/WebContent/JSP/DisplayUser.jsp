...
<body>
	<%
		...
		try {
			...
			objUserListBean = (UserListBean) request.getAttribute("displayList");
	...
	%><bean:message key="label.display.salutation" />
	<%
		out.println(":</th><td>" + objUserListBean.getSalutation());
			out.println("</td></tr><th>");
	%><bean:message key="label.display.firstname" />
	<%
		out.println(" :</th><td>" + objUserListBean.getFirstName());
			out.println("</td></tr><th>");
	%><bean:message key="label.display.middleinitial" />
	<%
		out.println(" :</th><td>" + objUserListBean.getMiddleInitial());
			out.println("</td></tr><th>");
	%><bean:message key="label.display.lastname" />
	<%
	...
	<%
		out.println(" :</th><td>" + objUserListBean.getGender());
			out.println("</td></tr><th>");
	%><bean:message key="label.display.email" />
	<%
		out.println(" :</th><td>" + objUserListBean.getEmail());
			out.println("</td></tr><th>");
	%><bean:message key="label.display.birthdate" />
	<%
		out.println(" : </th><td>" + objUserListBean.getBirthDate() + "/" + objUserListBean.getBirthMonth()
					+ "/" + objUserListBean.getBirthYear());
			out.println("</td></tr><th>");
	%><bean:message key="label.display.address" />
	<%
		out.println(" :</th><td>" + objUserListBean.getAddress());
			out.println("</td></tr><th>");
	%><bean:message key="label.display.userid" />
	<%
		out.println(" :</th><td>" + objUserListBean.getUserName());
			out.println("</td></tr><th> ");
	%><bean:message key="label.display.password" />
	<%
		out.println(" :</th><td>" + objUserListBean.getPassword());
			out.println("</td></tr><th> ");
	%><bean:message key="label.display.areaofinterest" />
	<%
		out.println(" :</th><td>" + objUserListBean.getAreaOfInterest());
			out.println("</td></tr><th> ");
	%><bean:message key="label.display.otherinterest" />
	<%
