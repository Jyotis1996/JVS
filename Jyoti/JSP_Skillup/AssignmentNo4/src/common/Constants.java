...
public class Constants {
	...
	public final static String QUERY_INSERT_RECORD = "INSERT INTO USERRDETAILS(USERID,PASSWORD,SALUTATION,FIRSTNAME,MIDDLEINITIAL,LASTNAME,SEX,EMAILID,BIRTHDATE,ADDRESS,AREAOFINTEREST,OTHERINTEREST) VALUES(?,?,?,?,?,?,?,?,?,?,?,?)";
	...
	public final static String REGEX_USERID = "[u3041-\u3096\u30A0-\u30FF\u4E00-\u9FBF]*";
	...
	public final static String INVALID_USERID = "You have entered invalid UserID. UserID must be japanesee character";
