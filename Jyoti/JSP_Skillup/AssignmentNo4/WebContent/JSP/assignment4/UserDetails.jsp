...
<title>UserDetailsC</title>

<META NAME="Description" CONTENT="UserDetailsC">
...
<body>
	...
	<FORM METHOD="POST"
		ACTION="${pageContext.request.contextPath}/UserDetailsC">
		...
		<TABLE align="center" border="2" cellpadding="2">
			...
			<TR>
				...
				<TH colspan="4">Areas of Interest <Font>*</Font>
				</TH>
			<TR>
	...
	<script type="text/javascript">
		...
		function clearFormData() {
			document.forms[0].action = '${pageContext.request.contextPath}/UserDetailsC_pre';
